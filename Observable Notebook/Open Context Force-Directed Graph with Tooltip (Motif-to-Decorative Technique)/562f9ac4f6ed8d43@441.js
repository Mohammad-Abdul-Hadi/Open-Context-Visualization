...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["mvd.json",new URL("./files/fa4e5313f0d1ffdaec07a13c3153a0a2ac614dfdafa844fb19dec4d166d2b29394778203723a14276f9d6d4adb2a6b3b5d9222ffa55d09d0c3946f7ee1a58105",import.meta.url)]]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], function(md){return(
md`# Open Context Force-Directed Graph with Tooltip (Motif-to-Decorative Technique)

The JSON Data for Motif-V-Decorative Technique can generated using the following [Jupyter Notbook](https://github.com/Mohammad-Abdul-Hadi/OpenContextVisualization/blob/master/Observable%20Notebook/data_for_FDG.ipynb).`
)});
...
> - Attach **mvd.json** for plotting Motif-V-Decorative Techniques `
)});
  main.variable(observer("data")).define("data", ["FileAttachment"], function(FileAttachment){return(
FileAttachment("mvd.json").json()
)});
