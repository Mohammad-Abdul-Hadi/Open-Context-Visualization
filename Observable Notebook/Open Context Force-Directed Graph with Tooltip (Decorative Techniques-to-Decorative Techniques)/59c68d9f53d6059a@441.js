...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["dvd.json",new URL("./files/ca45be30567eeb7d8b286dd4dc5df3e6cf3ab950c8a8f16a912a8bb1e45f117c7cb1aa2e7dba80208f9a7a24254b203999297b97243e7d76cb28e5ab7e1411aa",import.meta.url)]]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], function(md){return(
md`# Open Context Force-Directed Graph with Tooltip (Decorative Techniques-to-Decorative Techniques)

The JSON Data for Decorative Techniques-V-Decorative Techniques can generated using the following [Jupyter Notbook](https://github.com/Mohammad-Abdul-Hadi/OpenContextVisualization/blob/master/Observable%20Notebook/data_for_FDG.ipynb).`
)});
  main.variable(observer("chart")).define("chart", ["data","d3","width","height","color","drag","invalidation"], function(data,d3,width,height,color,drag,invalidation)
{
  ...
  main.variable(observer()).define(["md"], function(md){return(
md`> ### Data Selection Instuctions:
> - Attach **dvd.json** for plotting Decorative Techniques-V-Decorative Techniques `
)});
  main.variable(observer("data")).define("data", ["FileAttachment"], function(FileAttachment){return(
FileAttachment("dvd.json").json()
)});
